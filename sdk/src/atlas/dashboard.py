"""Render a dependency-free static Atlas operations dashboard."""
...
<main>
  <header>
    <div><h1>Atlas Operations</h1><p class="muted">Evidence-backed fleet status</p></div>
