"""Command-line boundary for Atlas operations."""
...
if TYPE_CHECKING:
    ...
    from atlas.operations import FleetOperations
    from atlas.validation import ValidatedState

from atlas.audit import AuditStatus, audit_inventory
...
from atlas.operations import UtcTimestamp, build_operations_view
from atlas.service_evidence import (
